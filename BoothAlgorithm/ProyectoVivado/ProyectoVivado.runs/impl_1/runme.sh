...
HD_PWD='C:/Users/victorsanavia/Documents/RepositoriosGit/NexysA7FreeProjects/BoothAlgorithm/ProyectoVivado/ProyectoVivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_booth_algorithm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_booth_algorithm.tcl -notrace
