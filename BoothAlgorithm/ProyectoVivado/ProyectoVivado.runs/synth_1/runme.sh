...
HD_PWD='C:/Users/victorsanavia/Documents/RepositoriosGit/NexysA7FreeProjects/BoothAlgorithm/ProyectoVivado/ProyectoVivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_booth_algorithm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_booth_algorithm.tcl
